...
namespace Bicep.Cli {
    ...
    internal class CliResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The specified input &quot;{0}&quot; was not recognized as a Bicep or Bicep test file. Valid files must use either the .bicep or .biceptest extension..
        /// </summary>
        internal static string UnrecognizedBicepOrBicepTestFileExtensionMessage {
            get {
                return ResourceManager.GetString("UnrecognizedBicepOrBicepTestFileExtensionMessage", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The specified input &quot;{0}&quot; was not recognized as a Bicep test parameters file. Valid files must use the .biceptestparam extension..
        /// </summary>
        internal static string UnrecognizedBicepTestParamFileExtensionMessage {
            get {
                return ResourceManager.GetString("UnrecognizedBicepTestParamFileExtensionMessage", resourceCulture);
            }
        }
